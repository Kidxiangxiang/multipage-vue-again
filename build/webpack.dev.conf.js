...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  // these devServer options should be customized in /config/index.js 此处的配置都是在config的index.js中设定好了
  devServer: {
  ...
  ].concat(utils.htmlPlugin())   //.concat(utils.htmlPlugin())为配置多页面新增
})
